...
let json = require('../common/settings.json');
    ...
    let getCurrentGame = (cardHidden,pubSub) => {
        ...
        if (currentGame.size == 0) {
            ...
            setTimeout(() => {
                ...
                //We convert the interval into a function
                let  bomboInterval =() => {
                ...
                // Store your slider in a variable
                let timer;
                  timer= setInterval(bomboInterval, json.game_speed);
                ...
                //When publish checked linea, stop interval and reset this after half second to close modal
                pubSub.subscribe("checkedlinea", () => {
                    clearInterval(timer)
                    setTimeout(() => {
                        timer= setInterval(bomboInterval, json.game_speed);
                    },  json.time_line);
