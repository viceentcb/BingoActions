...
const app = (() => {
    ...
    let myApp;
    const speed = game_speed; //in miliseconds
    let bombo;
    let players = []
    ...
    let start = () => {
        ...
        let doc = new DOMParser().parseFromString(`
            <div class="gameLayout">
                ...
                <div class="icon">
                <div id="play_pause" class="pauseicon"></div>
              </div>
            </div>
        `, 'text/html');
        ...
        */
        ...
        play_pause.onclick = function () {
            if (play_pause.className == "pauseicon"){
                play_pause.className = "playicon"
            stop()
        }else {
            play_pause.className = "pauseicon"
            myApp = setInterval(getBallFromBombo, app.speed);
