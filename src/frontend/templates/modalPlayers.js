...
import { modalMainMenu } from '../templates/modalMainMenu'
import '../css/modalPlayers.css';
import { game_speed } from '../../common/settings.json';
let seconds = Math.floor((game_speed / 1000) % 60);
// import { debug, clearModal , showModal } from '../js/core/core.js';

// import { renderPlayersLobby } from '../templates/modalLobbyPlayers';
...
function setupBackgroundVideo() {
    let backgroundVideo = `
        <div id="div_bg" class="bg">
            <video autoplay muted loop id="videoBackground">
                <source id="algo" src="${video}" type="video/mp4">
    ...
    videoEl.childNodes[1].addEventListener("loadeddata", function (ev) {
        videoEl.childNodes[1].currentTime += Math.round(Math.random() * videoEl.childNodes[1].duration);
    }, true);
...
export const modalPlayers = () => {
    ...
    const controllers = () => {
        ...
        */
        ...
        let back_menu = document.getElementById('menu');
    ...
    return {
        template:
            ...
            <div id="playersForm" class="modal">
                <!-- Modal content -->
                <button id='menu' class="back_menu">Menu</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="spinner__opts" style="margin-left:10px">
                        ...
                        <div class="spinner">
                            ...
                            <input type="number" id="spinner__value" class="spinner__value" name="time" id="match_time" min="0.1" max="5" step="0.1" value="${seconds}">
